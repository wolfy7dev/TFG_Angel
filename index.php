...
if (!isset($_SESSION['username'])) {
    ...
    $userInfo = "<span class='session-user'><p>Bienvenido, $username</p></span>";
}
?>
            ...
            <div class="container">
                ...
                <label for="c1" class="card">
                    <div class="row">
                        ...
                        <div class="description">
                            <h4>PERSONAJES</h4>
                            <a href="vista/personajes.php">VER MAS</a>
                        </div>
                    </div>
                </label>
                ...
                <label for="c2" class="card">
                    <div class="row">
                        ...
                        <div class="description">
                            <h4>LUGARES</h4>
                            <a href="vista/localizaciones.php">VER MAS</a>
                        </div>
                    </div>
                </label>
                ...
                <label for="c3" class="card">
                    <div class="row">
                        ...
                        <div class="description">
                            <h4>CREWS</h4>
                            <a href="vista/crews.php">VER MAS</a>
                        </div>
                    </div>
                </label>
                ...
                <label for="c4" class="card">
                    <div class="row">
                        ...
                        <div class="description">
                            <h4>BARCOS</h4>
                            <a href="vista/barcos.php">VER MAS</a>
                        </div>
                    </div>
                </label>
                ...
                <label for="c5" class="card">
                    <div class="row">
                        ...
                        <div class="description">
                            <h4>CAPITULOS</h4>
                            <a href="vista/capitulos.php">VER MAS</a>
                        </div>
                    </div>
                </label>
                ...
                <label for="c6" class="card">
                    <div class="row">
                        ...
                        <div class="description">
                            <h4>FRUTAS</h4>
                            <a href="vista/frutas.php">VER MAS</a>
                        </div>
                    </div>
                </label>
                ...
                <label for="c7" class="card">
                    <div class="row">
                        ...
                        <div class="description">
                            <h4>Episodios</h4>
                            <a href="vista/episodios.php">VER MAS</a>
                        </div>
                    </div>
                </label>
                ...
                <label for="c8" class="card">
                    <div class="row">
                        ...
                        <div class="description">
                            <h4>HAKIS</h4>
                            <a href="vista/hakis.php">VER MAS</a>
                        </div>
                    </div>
                </label>
