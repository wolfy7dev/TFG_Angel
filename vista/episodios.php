...
<head>
    ...
    <script type="text/javascript" src="js/scriptEp.js" defer></script>
</head>
    ...
    <main>
        <div class="bg_img">
            <header>
                ...
                <div class="session-user">
                    ...
                    if (isset($_SESSION['username'])) {
                        ...
                        echo 'No tienes iniciado la sesion';
                    }
                    ?>
            ...
            <div id="buscador">
                ...
                <input type="text" id="input-busqueda" placeholder="Buscar perepisodio..." oninput="buscarEpisodio()">
                <!-- Botón de búsqueda -->
            </div>
        ...
        <section id="comment-section">
            <h2 class="chat-title">Comenta las Episodios con la comunidad</h2> <br>
            <form id="comment-form" method="post">
                <textarea name="text" id="comment-text" placeholder="Escribe tu comentario..." required></textarea>
                <input type="hidden" name="categoria" value="episodios">
                <button type="submit">Comentar</button>
            </form>
            <?php mostrarComentarios($conn, 'episodios'); ?>
        </section>
        </div>
    </main>
