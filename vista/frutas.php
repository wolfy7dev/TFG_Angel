  ...
  <main>
    <div class="bg_img">
      ...
      <div id="buscador">
        ...
        <input type="text" id="input-busqueda" placeholder="Buscar fruta del diablo..." oninput="buscarFruta()">
        <!-- Botón de búsqueda -->
      </div>
    ...
    <section id="comment-section">
      <h2 class="chat-title">Comenta las frutas con la comunidad</h2> <br>
      ...
      <?php mostrarComentarios($conn, 'frutas'); ?>
    </section>
    </div>
  </main>
