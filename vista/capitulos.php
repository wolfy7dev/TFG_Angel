...
<head>
  ...
  <script type="text/javascript" src="js/scriptCap.js" defer></script>
</head>
...
<body>
  <main>
    ...
    <section id="comment-section">
      <h2 class="chat-title">Comenta los Capitulos con la comunidad</h2> <br>
      <form id="comment-form" method="post">
        <textarea name="text" id="comment-text" placeholder="Escribe tu comentario..." required></textarea>
        <input type="hidden" name="categoria" value="capitulos">
        <button type="submit">Comentar</button>
      </form>
      <?php mostrarComentarios($conn, 'capitulos'); ?>
    </section>
    </div>
  </main>
</body>
