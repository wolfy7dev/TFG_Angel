...
<head>
    ...
    <script type="text/javascript" src="js/scriptBar.js" defer></script>
</head>
    ...
    <main>
        <div class="bg_img">
            ...
            <div id="buscador">
                ...
                <input type="text" id="input-busqueda" placeholder="Buscar barco..." oninput="buscarBarco()">
                <!-- Botón de búsqueda -->
            </div>
        ...
        <section id="comment-section">
            <h2 class="chat-title">Comenta los barcos con la comunidad</h2> <br>
            <form id="comment-form" method="post">
                <textarea name="text" id="comment-text" placeholder="Escribe tu comentario..." required></textarea>
                <input type="hidden" name="categoria" value="barcos">
                <button type="submit">Comentar</button>
            </form>
            <?php mostrarComentarios($conn, 'barcos'); ?>
        </section>
        </div>
    </main>
